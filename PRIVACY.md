...
- 刪除：刪掉 app 就會清掉手機上的連線代碼；伺服器上的遊戲資料在重啟時清除。
...
- Deleting data: deleting the app removes the connection code from your phone; game data on the
  server is erased when it restarts.
